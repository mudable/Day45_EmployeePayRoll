...
const createInnerHtml = () => {
    ...
    for (let employeePayrollData of employeePayrollList) {
        ...
        <tr>
            ...
            <td>
                <img id="${employeePayrollData._id}" onclick="remove(this)" alt="delete" src="C:\\Users\\HP WORLD\\Desktop\\Day45_EmployeePayRoll\\assets\\icons\\delete-black-18dp.svg">
                <img id="${employeePayrollData._id}" onclick="update(this)" alt="edit" src="C:\\Users\\HP WORLD\\Desktop\\Day45_EmployeePayRoll\\assets\\icons\\create-black-18dp.svg">
            </td>
        </tr>
        `;
    }
